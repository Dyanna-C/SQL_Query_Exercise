...
-- Answer employee 1 sold the most rentals ( orignally I wronte staff 2 even though I got the right output
-- I know that staff_id 1 sold 8040 and staff_id 2 sold 8004 so staff one sold more)
SELECT *
FROM rental 
